...
@section('content')
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Result of
                                    {{ $result->student->name }}</li>
                            </ol>
                        </nav>
    ...
    <div class="result-card">
        ...
        <!-- Student Photo -->
        <img src="{{ asset('backend/images/students/' . $result->student->image) }}" alt="Student Photo"
            class="student-photo">
        ...
        <div class="text-center mt-4 no-print"> {{-- no-print ক্লাস দিলে প্রিন্টের সময় বাটন আসবে না --}}
            <button onclick="window.print()" class="btn btn-info text-white">
                <i class="fa fa-print"></i> Print Result
            </button>

            <a href="{{ route('result.download', $result->id) }}" class="btn btn-primary">

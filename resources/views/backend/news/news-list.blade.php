            ...
            <tbody>
                @foreach ($newspaper as $news)
                    <tr>
                        ...
                        <td>{{ $news->title }}</td>
                        <td>
                            <img src="{{ asset('backend/images/news/' . $news->image) }}" width="80" height="60"
                                class="rounded">
                        </td>
                        ...
                        <td>
                            <a href="{{ url('/admin/news/edit/' . $news->id) }}" class="btn btn-sm btn-info"><span
                                    class="mdi mdi-pencil"></span></a>
                            <a href="{{ url('/admin/news/delete/' . $news->id) }}" type="submit"
                                class="btn btn-sm btn-danger"
                                onclick="return confirm('Are you sure you want to delete this news?')"><span

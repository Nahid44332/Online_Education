                        ...
                        <tbody class="text-center">
                            @forelse ($certificates as $key => $certificate)
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <span
                                            class="fw-bold d-block text-dark">{{ $certificate->student->name ?? 'Deleted Student' }}</span>
                                    </td>
                                    <td><span
                                            class="badge bg-light text-dark border">#{{ $certificate->student->id ?? 'N/A' }}</span>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        <i class="fa-solid fa-certificate d-block mb-2"

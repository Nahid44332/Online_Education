<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    {{-- লোগো লিঙ্ক ট্রেইনার ড্যাশবোর্ডে যাবে --}}
    <a class="navbar-brand brand-logo" href="{{ route('trainer.dashboard') }}">
        <img src="{{ asset('backend/images/seetings/'.$sitesettings->logo) }}" alt="logo"/>
    </a>
    <a class="navbar-brand brand-logo-mini" href="{{ route('trainer.dashboard') }}">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch">
    ...
    <div class="search-field d-none d-md-block">
      {{-- সার্চ ফিল্ড খালি রাখা হয়েছে যেমনটি তোমার কোডে ছিল --}}
    </div>
      ...
      <li class="nav-item nav-profile dropdown">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="nav-profile-img">
            {{-- সাব-এডমিন টেবিল থেকে ট্রেইনারের ছবি --}}
            <img src="{{ asset('backend/images/trainer/' . Auth::guard('subadmin')->user()->trainer->profile_image) }}" alt="profile" />

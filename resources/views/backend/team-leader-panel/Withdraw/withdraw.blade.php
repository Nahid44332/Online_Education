            ...
            <div class="card shadow-sm border-0" style="border-radius: 15px;">
                <div class="card-header bg-white py-3 text-center">
                    <h4 class="mb-0 text-dark fw-bold">
                        <i class="mdi mdi-cash-withdrawal me-2 text-primary"></i>Withdraw Request
                    </h4>
                    <p class="text-muted small mb-0">Withdraw your Earn Money</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('team_leader.withdraw.store') }}" method="POST">
                        @csrf
                        
                        {{-- বর্তমান ব্যালেন্স দেখানোর জন্য একটা ছোট সেকশন --}}
                        <div class="p-3 mb-4 text-center" style="background: #f8f9fa; border-radius: 10px; border: 1px dashed #dee2e6;">
                            <span class="text-muted d-block small">Balance</span>
                            <h3 class="text-primary fw-bold mb-0">৳ {{ number_format($tl_data->points ?? 0, 2) }}</h3>
                        </div>

                        <div class="mb-3">
                            <label class="fw-bold small mb-2">Amount</label>
                        ...
                        <div class="mb-4">
                            <label class="fw-bold small mb-2">Account Number</label>
                            <div class="input-group">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg fw-bold shadow-sm" style="border-radius: 10px;">
                                <i class="mdi mdi-send me-2"></i> Send Request
                            </button>
                        </div>
                    </form>
                </div>
                <div class="card-footer bg-light py-3 text-center" style="border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    <p class="mb-0 small text-muted">পেমেন্ট প্রসেস হতে ২৪-৪৮ ঘণ্টা সময় লাগতে পারে।</p>
                </div>
            </div>
        </div>
    </div>
